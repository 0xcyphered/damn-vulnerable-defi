...
describe("[Challenge] Free Rider", function () {
  ...
  it("Exploit", async function () {
    ...
    const FreeRiderExploitFactory = await ethers.getContractFactory(
      "FreeRiderExploit",
      attacker
    );
    this.exploit = await FreeRiderExploitFactory.deploy(
    ...
    await this.exploit.start([0, 1, 2, 3, 4, 5], NFT_PRICE, { gasLimit: 1e6 });
  });
